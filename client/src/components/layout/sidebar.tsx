...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Enhanced Sidebar */}
      <div className={cn(
        "fixed top-0 left-0 h-screen w-64 bg-white z-50 transition-all duration-300 ease-in-out",
        "border-r border-slate-200/80",
        "shadow-[0_0_20px_rgba(0,0,0,0.04),_inset_-1px_0_0_rgba(240,240,250,0.95)]",
        "lg:static lg:translate-x-0", 
        isOpen ? "translate-x-0" : "-translate-x-full",
        "flex flex-col"
      )}>
        {/* Enhanced Logo Header with refined 3D Effects */}
        <div className="relative h-24 overflow-hidden border-b border-slate-100">
        ...
        {/* Navigation with improved visuals */}
        <div className="flex-grow overflow-y-auto custom-scrollbar px-3 py-4 space-y-6">
          <div>
        ...
        <div className="mt-auto">
          {/* Improved separator gradient with better color blending */}
          <div className="h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent opacity-80"></div>

          {/* User card with enhanced hover effects and feedback */}
          <div className="p-3">
          ...
          {/* Enhanced app version with better styling */}
          <div className="px-5 py-2 text-[10px] text-slate-400 text-center bg-slate-50/50 border-t border-slate-100">
            <span className="opacity-70">WeeklyPlanner</span> <span className="font-medium opacity-90">Pro v1.0</span>
          </div>
        </div>
      </div>
    </>
